...
public class DtoSheetCellSerializer implements JsonSerializer<DtoSheetCell> {
    ...
    public JsonElement serialize(DtoSheetCell src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        // Serialize predictedValues and isPredictedValuesWorked
        jsonObject.add("predictedValues", context.serialize(src.getPredictedValues()));
        jsonObject.addProperty("isPredictedValuesWorked", src.isPredictedValuesWorked());
